...
TEST_F(DefineTest, test_pointer) {
    ...
    std::cout << boost::core::demangle(typeid(std::pointer_traits<decltype(a)>::rebind<B>).name())
              << std::endl;
    std::cout << boost::core::demangle(typeid(std::pointer_traits<decltype(as)>::rebind<B>).name())
              << std::endl;
    std::cout << boost::core::demangle(typeid(std::pointer_traits<decltype(au)>::rebind<B>).name())
              << std::endl;
}
